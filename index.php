...
$gravatar = md5( strtolower( trim( "austincrane@gmail.com" ) ) );
$email = 'austincrane@gmail.com';

?>
  <button class="show-card">
    <img src="http://www.gravatar.com/avatar/<?php echo $gravatar; ?>" />
    click me
  </button>
  <article class="card">
    <section class="close">X
    ...
    <section class="details">
      <h2 class="name">Austin Crane</h2>
      <p class="description">Austin is a Charlotte-based front-end developer who enjoys watching his son dance.</p>
    </section>
    ...
    <section class="icon-bar">
      <ul>
        <li>
          <a href="https://www.linkedin.com/in/austincrane">
        ...
        <li>
          <a href="https://github.com/accrane">
            <svg viewBox="0 0 512 512">
